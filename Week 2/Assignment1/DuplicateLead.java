...
public class DuplicateLead {
    ...
    //18. Get the Title of Resulting Page(refer the video)  using driver.getTitle()
    //19. Click on Duplicate button
    //20. Clear the CompanyName Field using .clear() And Enter new CompanyName
    //21. Clear the FirstName Field using .clear() And Enter new FirstName
    //22. Click on Create Lead Button
    //23. Get the Title of Resulting Page(refer the video)  using driver.getTitle()
		...
		WebElement FrstNm = driver.findElement(By.id("createLeadForm_firstName"));
		FrstNm.clear();
		FrstNm.sendKeys("SARAVANAKANNAN");
